...
function swift_get_acf_block_template_map() {
	return [
		'acf/downloads'     => 'acf_blocks/downloads.php',
		'acf/button'        => 'acf_blocks/button.php',
		'acf/iframe'        => 'acf_blocks/iframe.php',
		'acf/accordiononly' => 'acf_blocks/accordion_only.php',
		'acf/accordion'     => 'acf_blocks/accordion.php',
		'acf/formonly'      => 'acf_blocks/form_only.php',
		'acf/newspaper'     => 'acf_blocks/newspaper.php',
		'acf/form'          => 'acf_blocks/form.php',
		'acf/rows'          => 'acf_blocks/rows.php',
		'acf/projects'      => 'acf_blocks/projects.php',
		'acf/text'          => 'acf_blocks/text.php',
		'acf/textimage'     => 'acf_blocks/text_image.php',
		'acf/textsidebar'   => 'acf_blocks/text_sidebar.php',
		'acf/gallery'       => 'acf_blocks/gallery.php',
		'acf/joboffers'     => 'acf_blocks/job_offers.php',
		'acf/titles'        => 'acf_blocks/tiles.php',
		'acf/logoslider'    => 'acf_blocks/logo_slider.php',
		'acf/reviews'       => 'acf_blocks/reviews.php',
		'acf/team'          => 'acf_blocks/team.php',
		'acf/posts'         => 'acf_blocks/posts.php',
		'acf/usps'          => 'acf_blocks/usps.php',
		'acf/contactwidget' => 'acf-widgets/contact.php',
		'acf/menuwidget'    => 'acf-widgets/menu.php',
		'acf/socialwidget'  => 'acf-widgets/social.php',
		'acf/textwidget'    => 'acf-widgets/text.php',
		'acf/imagewidget'   => 'acf-widgets/image.php',
	];
}
...
function swift_acf_block_type_args( $args, $name = null ) {
	...
	$args['render_callback'] = 'swift_render_acf_block';
