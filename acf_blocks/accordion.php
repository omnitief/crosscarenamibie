...
<section <?= $full_id; ?> class="<?= "text-image pr {$section_class} {$space} {$background_color}"; ?>">
	<?php divider() ?>
		...
		<div class="container">
			...
			if ($show_text_and_image) { 
				...
				<div class="row gap-row f--sb">
					<div class="col-12 col-lg-6 col-xl-5 text-image__text">
						<div class="text">
						<?php
					...
					<div class="col-12 col-lg-6 pb pt">
						<?php 
						if ($accordion) {
